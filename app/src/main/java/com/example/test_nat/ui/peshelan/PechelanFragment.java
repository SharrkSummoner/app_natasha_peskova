package com.example.test_nat.ui.peshelan;
...
public class PechelanFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        title.setText("Музеи Пешеланя");

        linearMuz1.setBackgroundResource(R.drawable.cornen_radius);
        textMuz1.setText("Музей горного дела, геологии и спелеологии Пешеланского гипсового завода");
        imageMuz1.setImageResource(R.drawable.pechelanmuz1);
